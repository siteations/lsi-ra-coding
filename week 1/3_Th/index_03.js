...
integrate your two objects to turn on and off, according to the button state

refactor and rework either element as necessary

use only mouse interactions - for the main triggering of effects

*bonus* - setup a spacebar interaction that turns everything on or off at once

a successful sketch will  include, at minimum setup(), draw(), button(), and emitter() functions and the above behavior - 8 buttons, each with their own emitter - which turns on and off together
